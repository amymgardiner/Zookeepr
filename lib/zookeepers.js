...
function filterByQuery(query, zookeepers) {
    ...
    if (query.ag) {
        filteredResults = filteredResults.filter(
            // singe our form data will be coming in as strings, and our JSON is storing age as a number, we must convert the query string to a number to perform a comparison
